...
// 최초에 hide 실행
$(function(){
    $('#isIdTrue, #isEmailTrue').hide(); 
    $('#isIdFalse, #isEmailFalse').hide(); 
});
</script>
            ...
            %>
                     ...
                     <div class="form-group blind">
                        <label class="btn btn-primary active"> <input
                           type="radio" name="user_role" autocomplete="off" value="일반 사용자"
                           checked>
                        </label>
                     </div>
                     <div class="form-group_id">
                        <input type="text" class="form-control1" placeholder="아이디"
                           ...
                           type="button" class="duplication" value="중복확인"
                           onclick="idCheck()"><br>
                     </div>
                     <span id="isIdTrue" style="color: blue">사용 가능한 ID 입니다.</span> <span
                        id="isIdFalse" style="color: red">ID가 이미 사용 중입니다.</span><br>
                     <div class="form-group_email">
                        <input type="text" class="form-control" placeholder="이메일"
                           name="user_email" id="user_email" maxlength="50"> <input
                           type="button" class="duplication" value="중복확인"
                           onclick="emailCheck()">
                     </div>
                     ...
                     <div class="form-group" style="text-align: center;">
                        <label class="btn btn-primary active"> <input
                           type="radio" name="user_gen" autocomplete="off" value="남자"
                           checked>남자
